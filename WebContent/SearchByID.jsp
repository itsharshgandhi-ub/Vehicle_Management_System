...
<title>Search Vehicle By ID</title>
</head>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2">
                    ...
                    <input type="hidden" name="source" value="searchbyiddisplay">
                        <div class="row control-group">
                            <div class="form-group col-xs-12 floating-label-form-group controls">
<p class="help-block text-danger"></p>
							<p class="gandhi">Vehicle ID</p>
                                <input type="text" name="vid"  class="form-control" placeholder="Vehicle ID" id="name" required data-validation-required-message="Please enter your name.">
                            </div>
                        </div>
                        </div>
                        <br>
